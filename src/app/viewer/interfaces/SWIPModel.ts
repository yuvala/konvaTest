...
import { DTOAttachmentPoint } from "./TemplatesModels";

export class BaseSWIPData {
    shapeType: string;
    shapeName: string;
    isVisible: boolean;
}

export class RulerSWIPData extends BaseSWIPData {
    p1: PointF;
    p2: PointF;
    label: BasicLabel;
}

export class CircleSWIPData extends BaseSWIPData {
    radius: number;
    center: PointF;
    label: BasicLabel;
}

export class AngleToolSWIPData extends BaseSWIPData {
    p1: PointF;
    p2: PointF;
    pVertex: PointF;
    label: BasicLabel;
...
export class TextToolSWIPData extends BaseSWIPData {
    text: string;
    fontSize: number;
...
export class InterLineSWIPData extends BaseSWIPData {
    Line1P1: PointF;
    Line1P2: PointF;
    Line2P1: PointF;
    Line2P2: PointF;
...
export class LLDSWIPData extends BaseSWIPData {
    pIschial1: PointF;
    pIschial2: PointF;
    pLesser1: PointF;
    pLesser2: PointF;
...
export class BasicLabel {
    name: string;
    text: string;
    position: PointF;
}

export class ImplantSWIPData extends BaseSWIPData{
