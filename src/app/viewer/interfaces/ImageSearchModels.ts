export class DTOResultBase {
    SystemErrorCode: EDTOStatus;
}
export class ESystemErrorCode {
    static None = 0;
...
export class EDTOPatientFolderView {
...
export class DTOResultRetrieveLevel {
    static caseLevel = 0;
...
export class DTOPatientFoldersResult extends DTOResultBase {
    Result: DTOPatientFolder[];
}

export class DTOSeriessesResult extends DTOResultBase {
    Result: DTOSeries[];
}

export class DTOPACSStudyQueryResult {
    PacsName: string;
    Studies: DTOStudy[];
}

export class DTOPACSStudiesResult extends DTOResultBase {
    Result: DTOPACSStudyQueryResult[];
}

export class DTOThumbnailsResult extends DTOResultBase {
